...
export const CoffeCard = ({ coffee }: Props) => {
    ...
    const addCoffeeCart = (coffee: CoffeType) => {
    ...
    return (
        <div className="bg-base-card w-full max-w-64 flex flex-col justify-center items-center px-4 py-3 rounded-bl-4xl rounded-tr-4xl rounded-tl-md rounded-br-md">
            <Image
                className="-mt-7"
                src={coffee.image}
                alt=""
            ...
            <h2 className="text-base-title font-title text-xl">{coffee.name}</h2>
            ...
            <div className="flex justify-between items-center w-full">
                ...
                <div className="flex gap-2 text-lg items-center">
                    ...
                    <button onClick={() => addCoffeeCart(coffee)}>
                        <Image
                            src="/Button.svg"
